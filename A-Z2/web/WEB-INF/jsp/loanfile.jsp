                        ...
                        <form role="form">
                            ...
                            <div class="form-group" >
                                <table>
                                    <tr>
                                 <td >Document Type :</td>
                                 <td ><input class="form-control" id="documentType"></td>	</tr>
                                </table><br>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td style="padding-left:30px;" ><input class="form-control" id="contactNo" ></td>
                                ...
                                <table border="0" >
                                    <tr>
                                        <td >Full Name:</td>
                                        <td>  &nbsp </td>
                                        <td style="padding-left:30px;"><input class="form-control" style="width:500px;" id="customerName"></td>					 
                                        <td>  &nbsp&nbsp&nbsp&nbsp </td>
                                        <td >Date Of Birth :</td>
                                        <td>  &nbsp&nbsp&nbsp&nbsp </td>
                                ...
                                <table align="center">
                                    <tr>
                                        <td >
                                            <div>
                                                <button type="button" class="btn btn-primary" onclick="addLoanFileDetails()">Submit</button>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
