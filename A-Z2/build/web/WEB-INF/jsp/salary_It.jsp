				...
				<br>
				 ...
				 <div class="row">
					 ...
					 <td>  &nbsp&nbsp&nbsp&nbsp </td>
					  ...
					  <td >Full Name:</td>
					 <td>  &nbsp </td>
					  <td style="padding-left:30px;"><input class="form-control" style="width:500px;"></td>					 
					 <td>  &nbsp&nbsp&nbsp&nbsp </td>
					  <td >Surname :</td>
					  <td>  &nbsp&nbsp&nbsp&nbsp </td>
					  <td><input class="form-control"></td>
					 ...
					 <td>  &nbsp&nbsp&nbsp&nbsp </td>
					  ...
					  <tr>
					 <td >Medical Prem :</td>
                                    <td style="padding-left:30px;" ><input class="form-control"></td>					 
					 <td>  &nbsp&nbsp&nbsp&nbsp </td>
					 ...
					 <td >Nature of Business :</td>
                                    <td style="padding-left:20px;" ><input class="form-control" style="width:300px;"></td>					 
					 <td>  &nbsp&nbsp&nbsp&nbsp </td>
					  ...
					  <td>  &nbsp </td>
					  <td align="left" ><input class="form-control" style="width:500px;"></td>					 
					 </tr>	
							</table>
							<br>
							 <table border="0" style="width:70%;">
					 ...
					 <td align="left">Additional Info :</td>
					  <td >(1)<input class="form-control" style="width:500px;"></td>	
					  </tr>
					   <td>  &nbsp&nbsp </td>
					 <br>
					  <tr>
					  <td>&nbsp&nbsp</td>
					  <td>(2)<input class="form-control" style="width:500px;"></td>	
					  </tr>
					   </table>
							...
							<div class="form-group">
								...
								<div class="form-group">
							     <label>Add Proof :&nbsp </label>
                                    <input type="checkbox">&nbsp Aadhar Card
                                </label>
								&nbsp <label class="checkbox-inline">
                                    <input type="checkbox">Voting-Id
                                </label>
                                &nbsp <label class="checkbox-inline">
                                    <input type="checkbox">Passport-Valid
                                </label>
                                &nbsp <label class="checkbox-inline">
                                    <input type="checkbox">Driving Licence-Valid
                                </label>
								...
								&nbsp <label class="checkbox-inline">
                                    <input type="checkbox">Light Bill - Rent Agree
                                </label>
							     ...
							     <label>Salary I.T Paper :&nbsp</label>
                                    <input type="checkbox">Form No 16 Last Years
                                </label>
								&nbsp <label class="checkbox-inline">
                                    <input type="checkbox">Cancel Cheque
                                </label>
                                &nbsp <label class="checkbox-inline">
                                    <input type="checkbox">Or Bank Details IFSC/MICR
                                </label>
                                &nbsp <label class="checkbox-inline">
                                    <input type="checkbox">Investment Copy-Details
                                </label>
                               &nbsp  <label class="checkbox-inline" >
                                    <input type="checkbox">Loan EMI STS Last Year
                                </label><br><br>
								<div class="form-group">
							     <label>Business I.T Paper :&nbsp </label>
								&nbsp <label class="checkbox-inline" >
                                    <input type="checkbox">Gumasta/Shop Act Copy
                                </label>
								&nbsp <label class="checkbox-inline">
                                    <input type="checkbox">Current Acc STS- 1 Yrs
                                </label>
								&nbsp <label class="checkbox-inline">
                                    <input type="checkbox">Investment Copy- Details
                                </label>
								&nbsp <label class="checkbox-inline">
                                    <input type="checkbox">Loan EMI STS Last Yrs
                                </label>
								 </div>
