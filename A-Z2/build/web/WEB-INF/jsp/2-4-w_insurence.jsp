				...
				<br>
				 ...
				 <div class="row">
					 ...
					 <td >  &nbsp&nbsp </td>
					  ...
					  <td>  &nbsp&nbsp </td>
					   <td >Email Id :</td>
					   <td style="padding-left:25px;" ><input class="form-control" ></td>
					  <td>  &nbsp&nbsp </td>
					 ...
					 <tr>
					  <td>Date of Birth :</td>
					  <td style="padding-left:10px;" ><input class="form-control" style="width:105%;"></td>
					  ...
					  <LABEL> DOCUMENTS REQUIRED :</LABEL><br>
								...
								&nbsp;&nbsp;&nbsp;<label class="checkbox-inline">
                                    <input type="checkbox"> OLD INSURANCE COPY
                                </label><br>							&nbsp;&nbsp;&nbsp;<label class="checkbox-inline">
                                    <input type="checkbox"> CHASSI PRINT ON HANDLE SITE(BY PENCILE)									
                                </label><br>
								&nbsp;&nbsp;&nbsp;<label class="checkbox-inline">
                                    <input type="checkbox"> RASHAN CARD BOOK XEROX
                                </label><br>
								&nbsp;&nbsp;&nbsp;<label class="checkbox-inline">
                                    <input type="checkbox"> PHOTO 5(FRONT, BACK, LEFT SIDE, RIGHT SIDE, KM METER)
                                </label><br>
								&nbsp;&nbsp;&nbsp;<label class="checkbox-inline">
                                    <input type="checkbox"> CHARGES AS PER VALUE OF BIKE
                                </label><br>
								&nbsp;&nbsp;&nbsp;<label class="checkbox-inline">
                                    <input type="checkbox"> 2/W THIRD PARTY INSURANCE CHARGES Rs.750/-
                                </label><br>
								&nbsp;&nbsp;&nbsp;<label class="checkbox-inline">
                                    <input type="checkbox"> 4/W THIRD PARTY CHARGES AS PER CC OF THE CAR
                                </label><br>
								&nbsp;&nbsp;&nbsp;<label class="checkbox-inline">
                                    <input type="checkbox">FIRST PARTY 4/W COMPULSURY INSPECTION BY COMPANY PERSON
                                </label><br>
								&nbsp;&nbsp;&nbsp;<label class="checkbox-inline">
                                    <input type="checkbox"> CHEQUE/CASH REQUIRE AS PER CALn
                                </label><br>
